...
ROSTER_VAULT = {
    ...
    "Boston Red Sox": {"pitcher": "Kutter Crawford", "batter": "Triston Casas"}, # DEVERS REMOVED FROM RED SOX
    "San Francisco Giants": {"pitcher": "Logan Webb", "batter": "Rafael Devers"}, # DEVERS ANCHORED TO GIANTS VAULT
